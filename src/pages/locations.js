...
export default function Locations()
{
 ...
 <div className="location-detail" id="Vernazza">
    ...
    <p>Vernazza is a picturesque village nestled on the rugged coastline of the Italian Riviera. With its colorful buildings, narrow streets, and stunning sea views, it's no wonder that Vernazza has become a must-visit destination for tourists from all over the world. Whether you're looking to soak up the sun on the beach, enjoy fresh seafood at a local restaurant, or simply wander the charming streets and take in the sights, Vernazza has something to offer everyone. Come see for yourself why this enchanting town has captured the hearts of so many travelers.</p>
 ...
 <div className="location-detail" id="istanbul">
    ...
    <div className="stars">
        ...
        <a href="*"><i className='bx bxs-star'></i></a>
        <a href="*"><i className='bx bxs-star'></i></a>
        <a href="*"><i className='bx bxs-star-half'></i></a>
    </div>
